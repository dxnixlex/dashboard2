...
class DetectorEnfermedades:
    def __init__(self, modelo_path, video_path, output_folder, db_path='vision_artificial.db'):
        self.model = YOLO(modelo_path)  # Cargar el modelo YOLO
        self.video_path = video_path  # Ruta del video a procesar
        self.output_folder = output_folder  # Carpeta para guardar las detecciones
    ...
    def procesar_video(self):
        ...
        frame_skip = 15  # Procesar 1 de cada 15 frames
        frame_count = 0
        detection_count = 0
...
# Configuración fija del script
if __name__ == "__main__":
    # Rutas fijas
    modelo_path = "C:/Users/WIN11/Desktop/Dashboard/complemento/backend/yolo11x.pt"  # Cambia esto por la ruta de tu modelo
    video_path = "C:/Users/WIN11/Desktop/Dashboard/complemento/backend/input/Professional_Mode_generates_a_realistic_high_defin.mp4"  # Cambia esto por la ruta de tu video
    output_folder = "C:/Users/WIN11/Desktop/Dashboard/complemento/backend/output"  # Cambia esto por la ruta de la carpeta de salida

    # Crear una instancia del detector y procesar el video
    detector = DetectorEnfermedades(modelo_path, video_path, output_folder)
